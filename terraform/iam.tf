...
resource "aws_iam_role" "unauthenticated_role" {
  name = "unauthenticated-control-financiero-role"
    ...
    Statement = [
      {
        ...
        Condition = {
          "StringEquals" = {
            "cognito-identity.amazonaws.com:aud" = aws_cognito_identity_pool.control_financiero_identity_pool.id
          }
...
resource "aws_iam_role" "authenticated_role" {
  name = "authenticated-control-financiero-role"
...
resource "aws_iam_role" "admin_role" {
  name = "admin-control-financiero-role"
...
resource "aws_iam_role" "general_role" {
  name = "general-control-financiero-role"
